    ...
    return (
        <div className="relative flex flex-col min-h-[calc(100vh-350px)] md:pt-8 pt-8 items-center justify-center">
            <div
                ...
                <Image className="mx-auto pb-5" src="/images/viously-large.png" alt="Viously logo" width={96} height={96} loading="lazy" />
                <a href="#">
                    <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Developper Frontend - Viously</h5>
                </a>
                <p className="mb-3 font-normal text-gray-500 dark:text-gray-400">Go to this step by step guideline process
