const SkillsAndLanguages = () => {
    return (
        <div className="flex flex-col items-center w-full md:max-w-lg lg:max-w-[calc(768px+10px)] max-w-sm p-6 bg-gray-100 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 h-full">
