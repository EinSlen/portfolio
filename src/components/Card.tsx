                  ...
                  {variant === "projectCard" ? (
                      <div>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 items-center gap-3 mt-2">
                          {techUsed?.split(",")?.map((item: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | PromiseLikeOfReactNode | Iterable<ReactNode> | null | undefined, index: Key | null | undefined) => (
                      <Typography
                        key={index}
                        size="small/normal"
                        variant="secondary"
