...
import LanguageSelector from "../sub/LanguagesSelector";
            ...
            <div className="w-full flex flex-col items-center justify-center m-auto">
                <div className="w-full h-full flex flex-row items-center justify-around flex-wrap">
                    <div className="min-w-[200px] h-auto flex flex-col items-center justify-start z-50">
                        <div className="font-bold text-[16px]">{t('translations:Footer.Reseau')}</div>
                    ...
                    <div className="min-w-[200px] h-auto flex flex-col items-center justify-start z-50">
                        <div className="font-bold text-[16px]">{t('translations:Footer.Contact')}</div>
                ...
                <div className="mb-[20px] text-[15px] text-center">
                    &copy; Valentin Damlencourt 2024 Inc. All rights reserved
                </div>
            </div>
        </div>
    )
